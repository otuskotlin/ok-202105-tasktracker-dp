...
class SqlConnector(
    private val url: String = "jdbc:postgresql://localhost:5432/tasktrackerdevdb",
    private val user: String = "postgres",
    private val password: String = "tasktracker-pass",
    private val schema: String = "tascktracker",
